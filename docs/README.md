...
|----------|-----|---------|------|---------|
| Product Requirements | ASTROCTL-PRD-001 | 1.15.1 | [`intent/`](intent/ASTROCTL-PRD-001.md) | *What must be true?* 288 numbered requirements (`HAL-01`, `PRF-12`, …), hardware scope, configuration schema, phase plan, risk register |
...
| Software Design | ASTROCTL-SDD-001 | 1.8.1 | [`design/`](design/ASTROCTL-SDD-001.md) | *How is each part built?* Rust types, trait signatures, wire protocols, task topology, route tables, storage formats, verification design |
