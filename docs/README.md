...
| Software Design | ASTROCTL-SDD-001 | 1.14.0 | [`design/`](design/ASTROCTL-SDD-001.md) | *How is each part built?* Rust types, trait signatures, wire protocols, task topology, route tables, storage formats, verification design |
