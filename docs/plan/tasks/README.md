...
| SDD v1.3.0 | `docs/design/ASTROCTL-SDD-001.md` | detailed design — **the spec for these tasks** |
| IMP v1.1.6 | `docs/plan/ASTROCTL-IMP-001.md` | milestone strategy, definition of done |
