...
| Doc | Path | Role |
|-----|------|------|
| PRD v1.15.2 | `docs/intent/ASTROCTL-PRD-001.md` | requirements (`XXX-nn` IDs), config schema (§8.1/§8.2 are normative) |
| ADD v1.4.1 | `docs/design/ASTROCTL-ADD-001.md` | architecture, ADRs, crate boundaries |
| SDD v1.11.0 | `docs/design/ASTROCTL-SDD-001.md` | detailed design — **the spec for these tasks** |
